...
abstract class Access implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Box\\Model\\Map\\AccessTableMap';
    ...
    /**
     * Initializes internal state of Box\Model\Base\Access object.
     */
    ...
    public function setCollectionId($v)
    {
        ...
        if ($this->collection_id !== $v) {
            ...
            $this->modifiedColumns[AccessTableMap::COL_COLLECTION_ID] = true;
        }
    ...
    public function setClientId($v)
    {
        ...
        if ($this->client_id !== $v) {
            $this->client_id = $v;
            $this->modifiedColumns[AccessTableMap::COL_CLIENT_ID] = true;
        }
    ...
    public function setLevel($v)
    {
        ...
        if ($this->level !== $v) {
            $this->level = $v;
            $this->modifiedColumns[AccessTableMap::COL_LEVEL] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AccessTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AccessTableMap::translateFieldName('CollectionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->collection_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AccessTableMap::translateFieldName('ClientId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->client_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AccessTableMap::translateFieldName('Level', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AccessTableMap::COL_COLLECTION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'collection_id';
        }
        if ($this->isColumnModified(AccessTableMap::COL_CLIENT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'client_id';
        }
        if ($this->isColumnModified(AccessTableMap::COL_LEVEL)) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Box\Model\Access The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AccessTableMap::COL_COLLECTION_ID)) {
            $criteria->add(AccessTableMap::COL_COLLECTION_ID, $this->collection_id);
        }
        if ($this->isColumnModified(AccessTableMap::COL_CLIENT_ID)) {
            $criteria->add(AccessTableMap::COL_CLIENT_ID, $this->client_id);
        }
        if ($this->isColumnModified(AccessTableMap::COL_LEVEL)) {
            $criteria->add(AccessTableMap::COL_LEVEL, $this->level);
        }
        if ($this->isColumnModified(AccessTableMap::COL_CREATED_AT)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Box\Model\Access (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Box\Model\Access Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCollection(ConnectionInterface $con = null)
    {
        if ($this->aCollection === null && ($this->collection_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCollection->addAccesses($this);
             */
        }
    ...
    {
        if (null !== $this->aClient) {
            $this->aClient->removeAccess($this);
        }
        if (null !== $this->aCollection) {
            $this->aCollection->removeAccess($this);
        }
        $this->id = null;
