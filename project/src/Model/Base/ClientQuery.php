 ...
 * @method     ChildClientQuery orderByDescription($order = Criteria::ASC) Order by the description column
 ...
 * @method     ChildClientQuery groupByDescription() Group by the description column
 ...
 *
 * @method     ChildClientQuery leftJoinDocumentLog($relationAlias = null) Adds a LEFT JOIN clause to the query using the DocumentLog relation
 * @method     ChildClientQuery rightJoinDocumentLog($relationAlias = null) Adds a RIGHT JOIN clause to the query using the DocumentLog relation
 * @method     ChildClientQuery innerJoinDocumentLog($relationAlias = null) Adds a INNER JOIN clause to the query using the DocumentLog relation
 *
 * @method     ChildClientQuery joinWithDocumentLog($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the DocumentLog relation
 *
 * @method     ChildClientQuery leftJoinWithDocumentLog() Adds a LEFT JOIN clause and with to the query using the DocumentLog relation
 * @method     ChildClientQuery rightJoinWithDocumentLog() Adds a RIGHT JOIN clause and with to the query using the DocumentLog relation
 * @method     ChildClientQuery innerJoinWithDocumentLog() Adds a INNER JOIN clause and with to the query using the DocumentLog relation
 *
 ...
 * @method     ChildClient|null findOneByDescription(string $description) Return the first ChildClient filtered by the description column
 * @method     ChildClient|null findOneBySecret(string $secret) Return the first ChildClient filtered by the secret column
 * @method     ChildClient|null findOneByIsAdmin(boolean $is_admin) Return the first ChildClient filtered by the is_admin column
 * @method     ChildClient|null findOneByIsDisabled(boolean $is_disabled) Return the first ChildClient filtered by the is_disabled column
 * @method     ChildClient|null findOneByCreatedAt(string $created_at) Return the first ChildClient filtered by the created_at column
 * @method     ChildClient|null findOneByUpdatedAt(string $updated_at) Return the first ChildClient filtered by the updated_at column *
 ...
 * @method     ChildClient requireOneByDescription(string $description) Return the first ChildClient filtered by the description column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildClient requireOneByIsDisabled(boolean $is_disabled) Return the first ChildClient filtered by the is_disabled column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildClient[]|ObjectCollection findByDescription(string $description) Return ChildClient objects filtered by the description column
 ...
 * @method     ChildClient[]|ObjectCollection findByIsDisabled(boolean $is_disabled) Return ChildClient objects filtered by the is_disabled column
...
abstract class ClientQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, name, description, secret, is_admin, is_disabled, created_at, updated_at FROM box_client WHERE id = :p0';
        try {
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ClientTableMap::COL_DESCRIPTION, $description, $comparison);
    }
    ...
    public function filterByDocumentLog($documentLog, $comparison = null)
    {
        if ($documentLog instanceof \Box\Model\DocumentLog) {
            return $this
                ->addUsingAlias(ClientTableMap::COL_ID, $documentLog->getClientId(), $comparison);
