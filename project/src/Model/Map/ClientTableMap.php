...
class ClientTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Secret', 'IsAdmin', 'CreatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'secret', 'isAdmin', 'createdAt', ),
        self::TYPE_COLNAME       => array(ClientTableMap::COL_ID, ClientTableMap::COL_NAME, ClientTableMap::COL_SECRET, ClientTableMap::COL_IS_ADMIN, ClientTableMap::COL_CREATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'secret', 'is_admin', 'created_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Secret' => 2, 'IsAdmin' => 3, 'CreatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'secret' => 2, 'isAdmin' => 3, 'createdAt' => 4, ),
        self::TYPE_COLNAME       => array(ClientTableMap::COL_ID => 0, ClientTableMap::COL_NAME => 1, ClientTableMap::COL_SECRET => 2, ClientTableMap::COL_IS_ADMIN => 3, ClientTableMap::COL_CREATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'secret' => 2, 'is_admin' => 3, 'created_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
