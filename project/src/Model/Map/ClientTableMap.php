...
class ClientTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\Box\\Model\\Client';
     ...
     */
    const COL_DESCRIPTION = 'box_client.description';
     ...
     */
    const COL_IS_DISABLED = 'box_client.is_disabled';
     ...
     */
    const COL_UPDATED_AT = 'box_client.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Description', 'Secret', 'IsAdmin', 'IsDisabled', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'description', 'secret', 'isAdmin', 'isDisabled', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(ClientTableMap::COL_ID, ClientTableMap::COL_NAME, ClientTableMap::COL_DESCRIPTION, ClientTableMap::COL_SECRET, ClientTableMap::COL_IS_ADMIN, ClientTableMap::COL_IS_DISABLED, ClientTableMap::COL_CREATED_AT, ClientTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'description', 'secret', 'is_admin', 'is_disabled', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Description' => 2, 'Secret' => 3, 'IsAdmin' => 4, 'IsDisabled' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'description' => 2, 'secret' => 3, 'isAdmin' => 4, 'isDisabled' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(ClientTableMap::COL_ID => 0, ClientTableMap::COL_NAME => 1, ClientTableMap::COL_DESCRIPTION => 2, ClientTableMap::COL_SECRET => 3, ClientTableMap::COL_IS_ADMIN => 4, ClientTableMap::COL_IS_DISABLED => 5, ClientTableMap::COL_CREATED_AT => 6, ClientTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'description' => 2, 'secret' => 3, 'is_admin' => 4, 'is_disabled' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    protected $normalizedColumnNameMap = [
        ...
        'COL_NAME' => 'NAME',
        'name' => 'NAME',
        'box_client.name' => 'NAME',
        'Description' => 'DESCRIPTION',
        'Client.Description' => 'DESCRIPTION',
        'description' => 'DESCRIPTION',
        'client.description' => 'DESCRIPTION',
        'ClientTableMap::COL_DESCRIPTION' => 'DESCRIPTION',
        'COL_DESCRIPTION' => 'DESCRIPTION',
        'description' => 'DESCRIPTION',
        'box_client.description' => 'DESCRIPTION',
        'Secret' => 'SECRET',
        'Client.Secret' => 'SECRET',
        'secret' => 'SECRET',
        'client.secret' => 'SECRET',
        'ClientTableMap::COL_SECRET' => 'SECRET',
        'COL_SECRET' => 'SECRET',
        'secret' => 'SECRET',
        'box_client.secret' => 'SECRET',
        'IsAdmin' => 'IS_ADMIN',
        'Client.IsAdmin' => 'IS_ADMIN',
        'isAdmin' => 'IS_ADMIN',
        'client.isAdmin' => 'IS_ADMIN',
        'ClientTableMap::COL_IS_ADMIN' => 'IS_ADMIN',
        'COL_IS_ADMIN' => 'IS_ADMIN',
        'is_admin' => 'IS_ADMIN',
        'box_client.is_admin' => 'IS_ADMIN',
        'IsDisabled' => 'IS_DISABLED',
        'Client.IsDisabled' => 'IS_DISABLED',
        'isDisabled' => 'IS_DISABLED',
        'client.isDisabled' => 'IS_DISABLED',
        'ClientTableMap::COL_IS_DISABLED' => 'IS_DISABLED',
        'COL_IS_DISABLED' => 'IS_DISABLED',
        'is_disabled' => 'IS_DISABLED',
        'box_client.is_disabled' => 'IS_DISABLED',
        'CreatedAt' => 'CREATED_AT',
        'Client.CreatedAt' => 'CREATED_AT',
        'createdAt' => 'CREATED_AT',
        'client.createdAt' => 'CREATED_AT',
        'ClientTableMap::COL_CREATED_AT' => 'CREATED_AT',
        'COL_CREATED_AT' => 'CREATED_AT',
        'created_at' => 'CREATED_AT',
        'box_client.created_at' => 'CREATED_AT',
        'UpdatedAt' => 'UPDATED_AT',
        'Client.UpdatedAt' => 'UPDATED_AT',
        'updatedAt' => 'UPDATED_AT',
        'client.updatedAt' => 'UPDATED_AT',
        'ClientTableMap::COL_UPDATED_AT' => 'UPDATED_AT',
        'COL_UPDATED_AT' => 'UPDATED_AT',
        'updated_at' => 'UPDATED_AT',
        'box_client.updated_at' => 'UPDATED_AT',
    ];
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ClientTableMap::COL_DESCRIPTION);
            $criteria->addSelectColumn(ClientTableMap::COL_SECRET);
            $criteria->addSelectColumn(ClientTableMap::COL_IS_ADMIN);
    ...
    public static function removeSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(ClientTableMap::COL_DESCRIPTION);
            $criteria->removeSelectColumn(ClientTableMap::COL_SECRET);
            $criteria->removeSelectColumn(ClientTableMap::COL_IS_ADMIN);
            $criteria->removeSelectColumn(ClientTableMap::COL_IS_DISABLED);
            $criteria->removeSelectColumn(ClientTableMap::COL_CREATED_AT);
            $criteria->removeSelectColumn(ClientTableMap::COL_UPDATED_AT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Box\Model\Client) { // it's a model object
